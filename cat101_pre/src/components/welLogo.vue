  ...
  <div class="header-g">
    ...
    <div class="block">
      ...
      <div class="login" v-if="$store.state.isLogin">
        <el-button size="small" round @click="$router.push('/layout/register')" style="margin-left: 30px">注册</el-button>
        <el-button size="small" round @click="$router.push('/layout/login')">登录</el-button>
      </div>
